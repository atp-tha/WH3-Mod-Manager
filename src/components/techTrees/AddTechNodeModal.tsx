...
const AddTechNodeModal = ({
  ...
  const existingTechnologyKeys = useMemo(
    ...
    if (option.technology.iconPath) {
      ...
      setSelectedIcon(
        matchedIcon || {
          ...
          label: option.technology.iconPath
        ...
        >
          ...
          <div className="flex gap-0 rounded-lg overflow-hidden border border-gray-700">
            ...
            <button
              type="button"
              className={`flex-1 px-4 py-2 text-sm font-medium ${
                technologyMode === "existing" ? "bg-blue-600 text-white" : "bg-gray-800 text-gray-300 hover:bg-gray-700"
              }`}
